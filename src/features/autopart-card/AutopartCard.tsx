...
export const AutopartCard = ({ 
  ...
  warehouses,
  notRefund,
}: ProductFromFavoritApiType) => {

  return (
    <div key={goodsID} className="w-80 p-6 bg-gray-100 hover:bg-gray- border border-gray-200 rounded-lg shadow">
      <Link href="#">
      ...
      <p className="mb-3 font-normal text-black">{(price * 1.2).toFixed(2)} руб.</p>
